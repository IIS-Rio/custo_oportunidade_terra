...
rfModel <- randomForest(formula=VTN_2022_log ~ DistCitiesover500k + PropPast + PropAgri + Relief + Climate + Soil + prop_urb + Prop_area_over_100ha + agri_subsidy_pop_total_2010 + PropAgriGDP + valor_prod_IBGE_2021 + PropNatVeg, data=df_sc, ntree=400)
...
- Adicionei todas as variáveis mencionadas no primeiro slide.
- Exclui distância estradas federais e mantive apenas estaduais
- Teste de importancia indicou que todas "são importantes"
- $R^2= 0.66$

---
Espacialização dados IBGE

```{r, echo=FALSE, out.width="80%",fig.align='center'}

knitr::include_graphics(path = "/dados/pessoal/francisco/custo_oportunidade_terra/figures/valor_producao_IBGE_2021.jpeg")


```
---
Espacializacao dados VTN RF

```{r, echo=FALSE, out.width="80%",fig.align='center'}

knitr::include_graphics(path = "/dados/pessoal/francisco/custo_oportunidade_terra/figures/VTN_RF_2022.jpeg")


```

---
Espacialização modelo predivito

```{r, echo=FALSE, out.width="80%",fig.align='center'}

knitr::include_graphics(path = "/dados/pessoal/francisco/custo_oportunidade_terra/figures/VTN_2022_predicted.jpeg")


```
---
# comparacao com valores ja usados IIS (AM 2030)

```{r, echo=FALSE, out.width="40%",fig.align='center'}

knitr::include_graphics(path = "/dados/pessoal/francisco/custo_oportunidade_terra/figures/scater_VTN_OC.jpeg")
...
---
# Próximos passos
- Resolver problemas do modelo
  - autocorrelação espacial 
  - preencher NAs
  - discutir "importância" das variáveis

- Conversão de VTN para arrendamento

$$r = (\tau - g) \cdot VTN $$

- $r$= valor arrendamento (reais $\cdot$ $ha^-1$)
- $\tau$ =  taxa de juros
- $g$ = taxa de ganho de capital
