...
ls <- list.files(p,pattern = "v2",full.names = T) # multi ano sao os valores preditos com o dado mais completo de vtn, usando rf 2019,2021,2022, 2023
...
writeRaster(m,"/dados/projetos_andamento/custo_oportunidade/rasters_VTN/predicted_VTN_BR_mosaico_v2.tif",overwrite=TRUE)
