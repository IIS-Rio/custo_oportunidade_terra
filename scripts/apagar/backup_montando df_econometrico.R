...
df_ind_full <- cbind(r_points@data,r_points@coords)

# salvando propveg - precisa juntar depois

write.csv(df_ind_full,"/dados/projetos_andamento/custo_oportunidade/data_econometric_model/PropNatVeg.csv")
...
df_noNA2 <- left_join(df_noNA,df_independent[,c(2,3)])
